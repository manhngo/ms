...
public final class DBUtitls {
    ...
    public static final String PLAYERS_COLUMN_SURVIVE = "survive";

    public static final String ROUND_DETAILS_TABLE = "round_details";

    public static final String ROUND_DETAILS_COLUMN_ID = "_id";
    public static final String ROUND_DETAILS_COLUMN_PLAYER = "player";
    public static final String ROUND_DETAILS_COLUMN_FUNCTION = "function";
    public static final String ROUND_DETAILS_COLUMN_ACTION = "action";
